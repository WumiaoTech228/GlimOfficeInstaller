...
namespace GOI.Helpers
{
    ...
    {
        public static readonly string RootPath = Path.Combine(Path.GetTempPath(), "GOI_Data");
        public static readonly string LogPath = Path.Combine(Path.GetTempPath(), "GOI_Logs");
